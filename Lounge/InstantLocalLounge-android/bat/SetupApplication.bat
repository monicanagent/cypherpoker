...
:: Android packaging
set AND_CERT_NAME="CypherPoker"
set AND_CERT_PASS=CypherPokerGenericCertPa$$
set AND_CERT_FILE=certificate\InstantLocalLounge.p12
...
:: Files to package
set APP_DIR=..\..\bin-output\InstantLocalLounge-android
set FILE_OR_DIR=-C ..\..\bin-output\InstantLocalLounge-android .
...
:: Output packages
set DIST_PATH=..\..\bin-output\APK
set DIST_NAME=CypherPoker
