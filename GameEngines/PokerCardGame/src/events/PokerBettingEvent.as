...
{	
	...
	public class PokerBettingEvent extends Event 
	{
		...
		//The current betting round has ended.
		...
		//Game has completed (all players have broadcast crypto keys and game results -- new dealer may now be assumed).
		public static var GAME_DONE:String = "Event.PokerBettingEvent.GAME_DONE";
